...
class BaseStockService:
    ...
    def __init__(self):
        ...
        self.symbols = [
            ...
            "OZGYO", "OZRDN", "OZSUB","PAGYO", "PAMEL", "PAPIL", "PARSN", "PASEU", "PATEK", 
            "PCILT", "PEHOL", "PEKGY", "PENGD", "PENTA", "PETKM", "PETUN", "PGSUS", "PKART", "PKENT", 
            "PNSUT", "POLHO", "POLTK", "PRDGS", "PRKAB", "PRKME", "PRZMA", "PSDTC", "PSGYO",
            "QUAGR", "RALYH", "RAYSG", "RNPOL", "RODRG", "ROYAL", "RTALB", "RUBNS", "RYGYO","RYSAS", "SAFKR", "SAHOL", "SAMAT", "SANEL", "SANFM", "SANKO", "SARKY", "SASA", "SAYAS", 
